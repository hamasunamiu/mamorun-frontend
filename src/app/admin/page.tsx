  ...
  if (loadError || !stats) {
    return (
      <main className="mx-auto flex min-h-screen w-full max-w-md items-center justify-center bg-[#FFF9F5] px-6">
        <ErrorMessage message={loadError ?? "統計情報を取得できませんでした。"} />
      </main>
    );
  }
      ...
      <div className="p-4 flex flex-col gap-3">
        <div
          ...
          <p className="text-4xl font-medium text-[#D85A30]">
            {stats.total_users} <span className="text-base text-[#993C1D]">人</span>
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#e0d6ce] p-4">
          ...
          <p className="text-4xl font-medium text-[#D85A30] mb-3">
            {stats.total_pets} <span className="text-base text-[#993C1D]">匹</span>
          </p>
        ...
        <div className="bg-white rounded-2xl border border-[#e0d6ce] p-4">
          ...
          <div className="flex items-center justify-between">
            <p className="text-4xl font-medium text-[#D85A30]">
              {stats.premium_users} <span className="text-base text-[#993C1D]">人</span>
            </p>
